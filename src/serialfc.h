...
#define IOCTL_FASTCOM_SET_SAMPLE_RATE _IOW(SERIALFC_IOCTL_MAGIC, 9, const int)
#define IOCTL_FASTCOM_GET_SAMPLE_RATE _IOR(SERIALFC_IOCTL_MAGIC, 10, unsigned *)

#define IOCTL_FASTCOM_SET_TX_TRIGGER _IOW(SERIALFC_IOCTL_MAGIC, 11, const int)
#define IOCTL_FASTCOM_GET_TX_TRIGGER _IOR(SERIALFC_IOCTL_MAGIC, 12, unsigned *)

#define IOCTL_FASTCOM_SET_RX_TRIGGER _IOW(SERIALFC_IOCTL_MAGIC, 13, const int)
#define IOCTL_FASTCOM_GET_RX_TRIGGER _IOR(SERIALFC_IOCTL_MAGIC, 14, unsigned *)

#define IOCTL_FASTCOM_SET_CLOCK_RATE _IOW(SERIALFC_IOCTL_MAGIC, 15, const int)

#define IOCTL_FASTCOM_ENABLE_ISOCHRONOUS _IOW(SERIALFC_IOCTL_MAGIC, 16, const int)
...
#define IOCTL_FASTCOM_ENABLE_EXTERNAL_TRANSMIT _IOW(SERIALFC_IOCTL_MAGIC, 19, const int)
...
#define IOCTL_FASTCOM_SET_FRAME_LENGTH _IOW(SERIALFC_IOCTL_MAGIC, 22, const int)
#define IOCTL_FASTCOM_GET_FRAME_LENGTH _IOR(SERIALFC_IOCTL_MAGIC, 23, unsigned *)
